...
namespace Formulario
{
    ...
    public class Instruccion
    {
        ...
        {
            return $"Trail {Trail} - Lat: {Punto.Lat}, Lon: {Punto.Long}";
        }
    }
    ...
    public class DroneAPIService
    {
        ...
        public async Task<List<Vuelo>> ObtenerTodosVuelosAsync()
        {
            ...
            {
                Console.WriteLine($"Error obteniendo vuelos: {ex.Message}");
                throw;
            }
        }
        ...
        public async Task<List<Instruccion>> ObtenerInstruccionesVueloAsync(string idVuelo)
        {
            ...
            {
                Console.WriteLine($"Error obteniendo instrucciones: {ex.Message}");
                throw;
            }
        }
        ...
        public async Task<Vuelo> CargarRutaAsync(string vueloId)
        {
            try
            {
                var vuelo = new Vuelo { ID = vueloId };
                vuelo.Instrucciones = await ObtenerInstruccionesVueloAsync(vueloId);
                return vuelo;
            }
            catch (Exception ex)
            {
                Console.WriteLine($"Error cargando ruta: {ex.Message}");
                throw;
            }
        }
    }
